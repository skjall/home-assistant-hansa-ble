...
echo "Mirroring hansa_ble to $SERVER:$HA_CONFIG/custom_components/ ..."
ssh "$SERVER" "mkdir -p $HA_CONFIG/custom_components/hansa_ble"
rsync -a --delete \
  --exclude '__pycache__' --exclude '*.pyc' \
  "$SCRIPT_DIR/custom_components/hansa_ble/" \
  "$SERVER:$HA_CONFIG/custom_components/hansa_ble/"
